...
public class Collisions extends SimState
{
    ...
    public void start()
    {
        ...
        */
        ...
        MobileCircle circ;
        pos = new Double2D(50, 185);
        circ = new MobileCircle(pos, new Double2D(0.5,0.0), size, "1");
        fieldEnvironment.setObjectLocation(circ, new sim.util.Double2D(pos.x, pos.y));
        objPE.register(circ);
        schedule.scheduleRepeating(circ);

        MobileCircle circ2;
        pos = new Double2D(150, 185);
        circ2 = new MobileCircle(pos, new Double2D(-0.5,0.0), size, "2");
