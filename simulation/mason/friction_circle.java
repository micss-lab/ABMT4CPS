...
public class MobileCircle extends MobileObject2D implements Steppable, ForceGenerator
{
    ...
    public int count;
    public String name;
    public MobileCircle(Double2D pos, Double2D vel, double radius, String name)
    {
        ...
        this.setCoefficientOfFriction(1);
        this.setCoefficientOfRestitution(0);
    ...
    public void step(SimState state)
    {
        ...
        System.out.println(this.name + ":" + this.getPosition());
    }

    public void addForce()
    {
        // Add gravity force
        this.addForce(new Double2D(0, 9.81));
    }
