...
public class Collisions extends SimState
{
    ...
    public void start()
    {
        ...
        */
        ...
        circ = new MobileCircle(pos, new Double2D(0,0.0), size, "1");
        fieldEnvironment.setObjectLocation(circ, new sim.util.Double2D(pos.x, pos.y));
        objPE.register(circ);
        schedule.scheduleRepeating(circ);

        MobileCircle circ2;
        pos = new Double2D(100, 130);
        circ2 = new MobileCircle(pos, new Double2D(0,0.0), size, "2");
        fieldEnvironment.setObjectLocation(circ2, new sim.util.Double2D(pos.x, pos.y));
        objPE.register(circ2);
        schedule.scheduleRepeating(circ2);

        MobileCircle circ3;
        pos = new Double2D(100, 100);
        circ3 = new MobileCircle(pos, new Double2D(0,0.0), size, "3");
        fieldEnvironment.setObjectLocation(circ3, new sim.util.Double2D(pos.x, pos.y));
        objPE.register(circ3);
        schedule.scheduleRepeating(circ3);
